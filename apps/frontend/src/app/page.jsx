      ...
      <main className="container mx-auto px-4 py-12 space-y-24">
        ...
        <section className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <h3 className="text-3xl md:text-4xl font-semibold text-green-500">
              Comunicación sin problemas
            </h3>
            <p className="text-gray-600 dark:text-gray-400 text-lg">
              Mantente conectado con tus contactos y comparte información de
              manera eficiente.
            </p>
        ...
        <section className="grid md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1 space-y-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg">
              Mantén el control de tus actividades y nunca pierdas una fecha
              importante.
            </p>
            <ul className="space-y-5">
              <FeatureItem icon={Calendar}>
                Organiza tus fechas con facilidad
              </FeatureItem>
              <FeatureItem icon={Clock}>
                Anota eventos importantes y recibe recordatorios
              </FeatureItem>
              <FeatureItem icon={Users}>
