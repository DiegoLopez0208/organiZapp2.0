...
import { groupValidation, groupParamsValidation } from '../middleware/validations.js'

export const groupRoutes = () => {
  const groupRouter = Router()
  const { getGroups, getGroupById, createGroup, updateGroup, deleteGroup } = groupController()

  groupRouter.route('/group')
    .get(getGroups)
    .post(groupValidation, createGroup) // Validaciones para crear un grupo
