  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      <div className="w-full max-w-md p-8 space-y-6 bg-gray-800 rounded-lg shadow-lg">
        <h2 className="text-3xl font-extrabold text-green-500 text-center">Iniciar sesión</h2>

        <div className="mt-4">
          <p className="text-sm font-medium text-center text-gray-400">Iniciar sesión con</p>
          ...
          <div className="relative mt-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 text-gray-400 bg-gray-800">O continuar con</span>
            </div>
          </div>
