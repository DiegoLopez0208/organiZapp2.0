    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 py-10 px-4 sm:px-6 lg:px-8">
      <ScrollArea className="h-[calc(100vh-5rem)]">
        <div className="max-w-4xl mx-auto space-y-8">
          <header>
            <h1 className="text-4xl font-bold text-center text-green-500 mb-2">Política de Privacidad</h1>
            <p className="text-center text-gray-400">Última actualización: 13 de septiembre de 2023</p>
          </header>

          <section>
            <h2 className="text-2xl font-semibold text-green-400 mb-4">Introducción</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-400 mb-4">Interpretación y Definiciones</h2>
            ...
            <p className="mb-2">Para los propósitos de esta Política de Privacidad:</p>
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>Compañía</strong> (referida como "la Compañía", "Nosotros", "Nos" o "Nuestro" en este Acuerdo) se refiere a OrganiZapp.</li>
              <li><strong>País</strong> se refiere a: Argentina</li>
              <li><strong>Dispositivo</strong> significa cualquier dispositivo que puede acceder al Servicio, como una computadora, un teléfono celular o una tableta digital.</li>
              ...
              <li><strong>Proveedor de Servicios</strong> significa cualquier persona natural o jurídica que procesa los datos en nombre de la Compañía. Se refiere a compañías de terceros o individuos empleados por la Compañía para facilitar el Servicio, proporcionar el Servicio en nombre de la Compañía, realizar servicios relacionados con el Servicio o ayudar a la Compañía a analizar cómo se utiliza el Servicio.</li>
              <li><strong>Datos de Uso</strong> se refiere a los datos recopilados automáticamente, ya sea generados por el uso del Servicio o de la infraestructura del Servicio en sí (por ejemplo, la duración de una visita a una página).</li>
              <li><strong>Sitio Web</strong> se refiere a OrganiZapp, accesible desde <a href="http://localhost:3000" className="text-green-400 hover:underline">http://localhost:3000</a></li>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-400 mb-4">Recopilación y Uso de sus Datos Personales</h2>
            ...
            <p className="mb-2">
              Mientras usa Nuestro Servicio, podemos pedirle que nos proporcione cierta información de identificación personal que puede ser utilizada para contactarlo o identificarlo. La información de identificación personal puede incluir, pero no se limita a:
            </p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-400 mb-4">Contáctenos</h2>
            <p className="mb-2">Si tiene alguna pregunta sobre esta Política de Privacidad, puede contactarnos:</p>
            <ul className="list-disc pl-5">
              <li>Visitando esta página en nuestro sitio web: <a href="https://localhost:3000" className="text-green-400 hover:underline">https://localhost:3000</a></li>
            </ul>
          </section>
        </div>
      </ScrollArea>
